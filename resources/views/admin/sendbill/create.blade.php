...
@if (isCompletedInfo())
    ...
    @section('content')
        ...
        <form method="POST" action="{{ route('sendbills.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input type="text" name="economic_unit" placeholder="نام واحد اقتصادی"
                                        class="form-control" value="{{ old('economic_unit') }}" required>
                                </div>
                                <div class="col-lg-6 mb-4">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input type="text" name="contractual_power" placeholder="قدرت قراردادی"
                                        class="form-control" value="{{ old('contractual_power') }}">
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <label for="file">بارگذاری فایل انرژی</label>
                                    ...
                                    <div class="mt-3">
                                        <img id="imagePreview" src="{{ asset('images/images.png') }}" alt="تصویر فعلی"
